<?php
/*
Plugin Name: Manifest Gallery
Plugin URI:
Description: A Gallery custom post type and shortcode to produce an array of image IDs
Version: 1.0.0
Author: Athletics
...
class Gallery {
	...
	private function __construct() {
		...
		add_action( 'init', array( $this, 'gallery_post_type' ), 10 );
		add_action( 'init', array( $this, 'gallery_acf' ) );
		add_shortcode( 'gallery', array( $this, 'gallery_shortcode' ) );
		add_shortcode( 'popup_gallery', array( $this, 'popup_gallery_shortcode' ) );
	...
	public function popup_gallery_shortcode( $atts ) {
