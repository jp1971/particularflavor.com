...
/*  Copyright 2015 Athletics (wordpress@athleticsnyc.com)
...
class CompatiblePostSharingSystem {
	...
	*/
	...
	private function __construct() {
		...
		register_uninstall_hook( __FILE__, array( 'CompatiblePostSharingSystem', 'uninstall' ) );
	...
	public function enqueue_styles() {
		...
		if ( 1 == get_option( 'cpss_css' ) ) {

			wp_enqueue_style(
				'cpss', //$handle
				get_template_directory_uri() . '/plugins/manifest-compatible-post-sharing-system/css/cpss/cpss.css', //$src
	   	...
	   	wp_enqueue_style(
			...
			get_template_directory_uri() . '/plugins/manifest-compatible-post-sharing-system/css/vendor/magnific-popup/magnific-popup.css', //$src
			false, //$deps (dependencies)
			'0.9.9', //$ver
			'screen' //$media
	   	);
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script(
			'cpss',//$handle
			get_template_directory_uri() . '/plugins/manifest-compatible-post-sharing-system/js/cpss/cpss.js', //$src
		...
		wp_enqueue_script(
			'magnific-popup',//$handle
			get_template_directory_uri() . '/plugins/manifest-compatible-post-sharing-system/js/vendor/magnific-popup/jquery.magnific-popup.min.js', //$src
...
$cpss = CompatiblePostSharingSystem::get_instance();